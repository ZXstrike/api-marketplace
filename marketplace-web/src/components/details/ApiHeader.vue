<template>
  <div v-if="api" class="flex flex-col md:flex-row justify-between md:items-center gap-4">
    ...
    <div class="flex-shrink-0">
      ...
      <button v-if="isLoggedIn" @click="$emit('subscribe')" class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3 rounded-lg shadow-lg flex items-center justify-center space-x-2">
